    ...
    >
      <div>
        ...
        <button
          className={`mt-8 flex items-center justify-center cursor-pointer ${
            expand
              ...
              : "group relative h-9 w-9 hover:bg-gray-500/30 mx-auto rounded-lg"
          }`}
        >
          <Image
        ...
        >
          ...
          <ChatsContainer openMenu={openMenu} setOpenMenu={setOpenMenu} />
        </div>
      </div>
      ...
      <div>
        ...
        >
          {user ? (
            ...
            <Image src={assets.profile_icon} alt="" className="" />
          )}
